      ...
      <footer className="py-5 ">
        ...
        <div className="d-flex flex-column flex-sm-row justify-content-between py-4 my-4 border-top">
          ...
          <ul className="list-unstyled d-flex">
            {/* <li className="ms-3"><a className="link-white" href="#"><BsFillChatFill/></a></li>
            <li className="ms-3"><a className="link-white" href="#"><BsWordpress/></a></li>
            <li className="ms-3"><a className="link-white" href="#"><BsYoutube/></a></li>
            <li className="ms-3"><a className="link-white" href="#"><BsTwitter/></a></li> */}
          </ul>
        </div>
      </footer>
    </div>
